...
export function Project({ title, description, tags, imageUrl }: ProjectProps) {
  ...
  return (
    ...
    >
      ...
      sm:h-[20rem] even:pl-8 hover:bg-gray-200 transition group-even:pl-8"
      >
        <div className="pt-4 pb-7 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full group-even:ml-[26rem]">
